...
public class GetPlayerAchievementsRequestHandlerTesting
{
    ...
    private readonly GetPlayerAchievementsRequestHandler handler;
    ...
    [Fact]
    public async Task GetPlayerAchievements_With_Player_Fail() 
    {
        var playerId = "122bbfee-373a-49b6-a7d0-200736fa046a";
